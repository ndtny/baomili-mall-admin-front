  ...
  <div style="display: flex; flex-direction: column">
    ...
    <el-table :data="tableData" stripe border fit max-height="84vh" style="width: 100%; overflow-y: auto;">
      ...
      <el-table-column :show-overflow-tooltip="true" align="center" prop="orderNumber" label="订单号" width="180"
                       sortable/>
      <el-table-column :show-overflow-tooltip="true" align="center" prop="productTotalPrice" label="商品总价"
                       width="120" sortable/>
      <el-table-column :show-overflow-tooltip="true" align="center" prop="freight" label="订单运费" width="120"
                       sortable/>
      <el-table-column :show-overflow-tooltip="true" align="center" prop="actualPayment" label="实付款" width="120"
                       sortable/>
      <el-table-column :show-overflow-tooltip="true" align="center" prop="paymentWay" label="支付方式" width="120"
                       sortable>
        <template #default="scope">
          <span>{{ scope.row.paymentWay === 1 ? '微信' : scope.row.paymentWay === 2 ? '支付宝' : '银行卡' }}</span>
        </template>
      </el-table-column>
      <el-table-column :show-overflow-tooltip="true" align="center" prop="createdTime" label="下单时间" width="160"
                       sortable/>
      <el-table-column :show-overflow-tooltip="true" align="center" prop="paymentTime" label="付款时间" width="160"
                       sortable/>
      <el-table-column :show-overflow-tooltip="true" align="center" prop="shippingTime" label="发货时间" width="160"
                       sortable/>
